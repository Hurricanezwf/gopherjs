...
var FS = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 3, 2, 18, 58, 37, 199645270, time.UTC),
		},
		"/js": &vfsgen۰DirInfo{
			name:    "js",
		...
		"/nosync": &vfsgen۰DirInfo{
			name:    "nosync",
			modTime: time.Date(2019, 1, 3, 14, 55, 7, 233669948, time.UTC),
		},
		...
		"/nosync/mutex.go": &vfsgen۰CompressedFileInfo{
			name:             "mutex.go",
			modTime:          time.Date(2019, 1, 3, 14, 55, 7, 233488960, time.UTC),
